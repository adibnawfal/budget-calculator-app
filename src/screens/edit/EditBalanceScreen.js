...
export default function EditBalanceScreen({ navigation, route }) {
  ...
  const [itemName, setItemName] = useState(route.params.item.itemName);
    ...
    >
      <SafeAreaView style={styles.container}>
        ...
        <View style={{ width: "100%" }}>
          ...
          <Text style={styles.titleTxt}>Edit item</Text>
